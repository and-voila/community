export default function RelatedLinks() {
  return (
    <section className="relative border-t border-gray-200 dark:border-gray-800">
      {/* Background gradient */}
      <div
        className="pointer-events-none absolute inset-0 bg-gradient-to-b from-gray-100 to-white dark:from-gray-800 dark:to-gray-900 dark:opacity-25"
        aria-hidden="true"
      />
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          {/* Items */}
          <div
            className="mx-auto grid max-w-xs gap-4 sm:max-w-none sm:grid-cols-2 md:max-w-none md:grid-cols-3 md:gap-6 lg:max-w-none"
            data-aos-id-rellinks
          >
            {/* 1st item */}
            <a
              className="group flex flex-col items-center bg-gradient-to-tr from-teal-500 to-teal-400 p-5 text-center text-white shadow-2xl dark:to-teal-500"
              href="#0"
              data-aos="fade-down"
            ...
            >
              ...
              <div className="font-red-hat-display mb-1 text-xl font-black tracking-tighter">
                Community Forum
              </div>
              <div className="mb-3 grow opacity-80">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              </div>
              <svg
                className="mb-1 h-4 w-4 transform transition duration-150 ease-in-out group-hover:rotate-45"
                viewBox="0 0 16 16"
                xmlns="http://www.w3.org/2000/svg"
              >
                <path
            ...
            {/* 2nd item */}
            <a
              className="group flex flex-col items-center bg-gradient-to-tr from-purple-500 to-purple-400 p-5 text-center text-white shadow-2xl dark:to-purple-500"
              href="#0"
              data-aos="fade-down"
              data-aos-anchor="[data-aos-id-rellinks]"
              data-aos-delay="150"
            ...
            {/* 3rd item */}
            <a
              className="group flex flex-col items-center bg-gradient-to-tr from-indigo-500 to-indigo-400 p-5 text-center text-white shadow-2xl dark:to-indigo-500 sm:col-span-2 md:col-auto"
              href="#0"
              data-aos="fade-down"
              data-aos-anchor="[data-aos-id-rellinks]"
              data-aos-delay="300"
