...
export function PageLinksLoader() {
  return (
    <div className="space-y-2 pl-8 before:bg-primary before:opacity-80 after:bg-primary after:opacity-70">
...
export function ListItemLoader() {
  return (
    <div className="pt-10 group-first:pt-0 group-first:before:hidden group-first:after:hidden">
